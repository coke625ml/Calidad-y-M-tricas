...
/****** Object:  View [dbo].[vw_indicadores_habilitados_desaf]    Script Date: 16/01/2020 15:21:13 ******/
SET ANSI_NULLS ON
GO
...
left join (select distinct ruc as ruc_seg, segmento as segmento_nuevo, subSegmento as subsegmento_nuevo from [Visanet Planeamiento].[DBO].[V_Segmento_Cliente]) as c on b.ruc = c.ruc_seg 
