...
select *
into #tab1
from gdc..tbl_AUTOGESTION_NEL_inicial
...
select a.*,
	   ...
	   else cast(YEAR(FECHA) as varchar) + MONTH(FECHA)
	   end as Periodo
into #tab2
from #tab1 as a
...
-- crear logicas de autogestion
	...
	-- mis depositos
		...
		from #tab8
		where Modulo in ('Inicio')
		and Sub_Modulo = 'Reportes'
		and Detalle in ('Mis Depositos')
...
select *
into gdc..tbl_AUTOGESTION_NEL_final
from #tab24