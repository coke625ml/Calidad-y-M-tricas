	...
	drop table #tab16
	select a.* , isnull (b.MargenComercio , 0 ) as MgCom_n_4 , isnull ( b.Volumen, 0 ) as Vol_n_4
	into #tab16
	from #Tab15 as a
	...
	drop table #tab17
	select a.* , isnull (b.MargenComercio , 0 ) as MgCom_n_5 , isnull ( b.Volumen, 0 ) as Vol_n_5
	into #tab17
	from #tab16 as a
	...
	select *
	into gdc..tbl_grupos_valor_vendemas_aislado_mgcom
	from #tab20