-- INSTRUCCIONES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  left join (select periodo, codigo, ruc, MargenTransaccion as margen_txn_n_4 from v_rentabilidad_margen)  as j on a.codigo_s = j.Codigo and convert(date,cast(a.periodo_s as varchar(10))+'01',112) = DATEADD(month,+4,convert(date,cast(j.periodo as varchar(10))+'01',112)) -- N - 4
  left join (select periodo, codigo, ruc, MargenTransaccion as margen_txn_n_5 from v_rentabilidad_margen)  as k on a.Codigo_s = k.Codigo and convert(date,cast(a.periodo_s as varchar(10))+'01',112) = DATEADD(month,+5,convert(date,cast(k.periodo as varchar(10))+'01',112)) -- N - 5
  left join (select periodo, codigo, ruc, MargenTransaccion as margen_txn_n_6 from v_rentabilidad_margen)  as x on a.Codigo_s = x.Codigo and convert(date,cast(a.periodo_s as varchar(10))+'01',112) = DATEADD(month,+6,convert(date,cast(x.periodo as varchar(10))+'01',112)) -- N - 6
  ...
  left join (select periodo, codigo, ruc, MargenTransaccion as margen_txn_n_7 from v_rentabilidad_margen)  as j on a.codigo_s = j.Codigo and convert(date,cast(a.periodo_s as varchar(10))+'01',112) = DATEADD(month,+7,convert(date,cast(j.periodo as varchar(10))+'01',112)) -- N - 7
  left join (select periodo, codigo, ruc, MargenTransaccion as margen_txn_n_8 from v_rentabilidad_margen)  as k on a.Codigo_s = k.Codigo and convert(date,cast(a.periodo_s as varchar(10))+'01',112) = DATEADD(month,+8,convert(date,cast(k.periodo as varchar(10))+'01',112)) -- N - 8
  left join (select periodo, codigo, ruc, MargenTransaccion as margen_txn_n_9 from v_rentabilidad_margen)  as x on a.Codigo_s = x.Codigo and convert(date,cast(a.periodo_s as varchar(10))+'01',112) = DATEADD(month,+9,convert(date,cast(x.periodo as varchar(10))+'01',112)) -- N - 9
