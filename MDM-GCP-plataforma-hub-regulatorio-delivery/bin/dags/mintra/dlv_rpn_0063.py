...
check_and_execute >> check_date_and_schedule_task >> task_dict["rpn_0063"] 

task_dict["rpn_0063"] >> task_dict["rpn_0063_exp"] >> next_dag_trigger_task

task_dict[dag_error_mail] << task_dict["rpn_0063"]

task_dict[dag_error_mail] << task_dict["rpn_0063_exp"]
