...
check_and_execute >> check_date_and_schedule_task >> task_dict["prueba_pdf"] 

task_dict[dag_error_mail] << task_dict["prueba_pdf"]

[all_failed,all_success] << task_dict["prueba_pdf"]