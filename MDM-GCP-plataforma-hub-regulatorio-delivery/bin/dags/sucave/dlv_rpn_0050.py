...
check_date_and_schedule_task >> task_dict["rpn_0050"] 

task_dict["rpn_0050"] >> task_dict["rpn_0050_exp"] >> next_dag_trigger_task

task_dict[dag_error_mail] << task_dict["rpn_0050"]

task_dict[dag_error_mail] << task_dict["rpn_0050_exp"]
