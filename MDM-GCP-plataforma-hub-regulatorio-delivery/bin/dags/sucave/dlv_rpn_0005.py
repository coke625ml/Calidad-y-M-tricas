...
from composer_hub_regulatorio_plugin import get_parameters, get_file_name, get_task_list
from composer_hub_regulatorio_plugin import get_bq_all_failed_joboperator,get_bq_all_success_joboperator, Constantes
...
#######################
    ...
    task_dict = get_task_list(scripts, Constantes.C_CAPA_DELIVERY, Constantes.C_REPORTES_SUCAVE)
...
check_date_and_schedule_task >> task_dict["rpn_0005"] 

task_dict["rpn_0005"] >> task_dict["rpn_0005_exp"] >> next_dag_trigger_task

task_dict[dag_error_mail] << task_dict["rpn_0005"]

task_dict[dag_error_mail] << task_dict["rpn_0005_exp"]
