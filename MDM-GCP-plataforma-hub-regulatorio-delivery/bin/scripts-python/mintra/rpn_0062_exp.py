...
ruta, inicio, lastdate = get_path_inicio(Constantes.C_RPN_0062)
...
file_name = f"Trimestral SOAT - Siniestralidad por Tipo de Vehiculo {C_QUARTER}Q{C_YYYY}.pdf"
...
datos_leyenda = {
    '''
* La información considera los últimos 12 meses desde el periodo de análisis.
* El índice de siniestralidad es calculado para periodos anuales, y es el resultado de dividir siniestros
entre las primas devengadas correspondientes a los 12 últimos meses.
* La definición de tipo de vehículo considera la clasificación de vehículos motores según clase y uso,
definido en las disposiciones transitorias de la Circular N° S-619-2006.
''': [''],
}
